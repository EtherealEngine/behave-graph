...
export const Path = new FunctionDesc({
    ...
    category: 'Logic',
    label: 'Path',
    helpDescription: 'If pathToSearch is "a.b" then it will return 1 if obj is {a:{b:1}}. It will return undefined, if such path is not found. See [Rambdax\'s path](https://selfrefactor.github.io/rambdax/#/?id=path)"',
    in: [
        {
            pathToSearch: 'string'
        },
