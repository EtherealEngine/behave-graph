...
export function mat3SetColumn3(m, columnIndex, column, result = new Mat3()) {
...
export function mat3SetRow3(m, rowIndex, row, result = new Mat3()) {
    const re = result.set(m.elements).elements;
...
export function column3ToMat3(a, b, c, result = new Mat3()) {
...
export function mat3Equals(a, b, tolerance = EPSILON) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
...
export function mat3Add(a, b, result = new Mat3()) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
        result.elements[i] = a.elements[i] + b.elements[i];
    }
    return result;
}
export function mat3Subtract(a, b, result = new Mat3()) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
        result.elements[i] = a.elements[i] - b.elements[i];
    }
    return result;
}
export function mat3MultiplyByScalar(a, b, result = new Mat3()) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
        result.elements[i] = a.elements[i] * b;
    }
    return result;
}
export function mat3Negate(a, result = new Mat3()) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
        result.elements[i] = -a.elements[i];
    }
    return result;
}
export function mat3Multiply(a, b, result = new Mat3()) {
    const ae = a.elements;
    const be = b.elements;
...
export function mat3Transpose(m, result = new Mat3()) {
    const me = m.elements;
    const te = result.elements;
    te[0] = me[0];
    te[4] = me[4];
...
export function mat3Inverse(m, result = new Mat3()) {
    const e = m.elements;
...
export function mat3Mix(a, b, t, result = new Mat3()) {
    const s = 1 - t;
    for (let i = 0; i < NUM_ELEMENTS; i++) {
...
export function mat3FromArray(array, offset = 0, result = new Mat3()) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
        result.elements[i] = array[offset + i];
    }
    return result;
}
export function mat3ToArray(a, array, offset = 0) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
        array[offset + i] = a.elements[i];
    }
}
export function mat3ToString(a) {
    return toSafeString(a.elements);
}
export function mat3Parse(text, result = new Mat3()) {
    return mat3FromArray(parseSafeFloats(text), 0, result);
}
export function eulerToMat3(euler, result = new Mat3()) {
    const te = result.elements;
...
export function quatToMat3(q, result = new Mat3()) {
...
export function scale2ToMat3(s, result = new Mat3()) {
    return result.set([s.x, 0, 0, 0, s.y, 0, 0, 0, 1]);
}
// from gl-matrix
export function mat3ToScale2(m, result = new Vec2()) {
...
export function translation2ToMat3(t, result = new Mat3()) {
    return result.set([1, 0, t.x, 0, 1, t.y, 0, 0, 1]);
}
export function mat3ToTranslation2(m, result = new Vec2()) {
    return result.set(m.elements[2], m.elements[5]);
}
export function scale3ToMat3(s, result = new Mat3()) {
    return result.set([s.x, 0, 0, 0, s.y, 0, 0, 0, s.z]);
}
// from gl-matrix
export function mat3ToScale3(m, result = new Vec3()) {
    const me = m.elements;
    const m11 = me[0];
    const m12 = me[1];
    const m13 = me[2];
...
export function mat4ToMat3(a, result = new Mat3()) {
    const ae = a.elements;
    return result.set([
        ae[0],
        ae[1],
