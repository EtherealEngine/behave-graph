import { EPSILON, equalsTolerance, parseSafeFloats, toSafeString } from 'ee-behave-graph-core';
...
export function mat4SetColumn4(m, columnIndex, column, result = new Mat4()) {
...
export function mat4SetRow4(m, rowIndex, row, result = new Mat4()) {
    const re = result.set(m.elements).elements;
...
export function column4ToMat4(a, b, c, d, result = new Mat4()) {
...
export function mat4Equals(a, b, tolerance = EPSILON) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
...
export function mat4Add(a, b, result = new Mat4()) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
        result.elements[i] = a.elements[i] + b.elements[i];
    }
    return result;
}
export function mat4Subtract(a, b, result = new Mat4()) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
        result.elements[i] = a.elements[i] - b.elements[i];
    }
    return result;
}
export function mat4MultiplyByScalar(a, b, result = new Mat4()) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
        result.elements[i] = a.elements[i] * b;
    }
    return result;
}
export function mat4Negate(a, result = new Mat4()) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
        result.elements[i] = -a.elements[i];
    }
    return result;
}
export function mat4Multiply(a, b, result = new Mat4()) {
    const ae = a.elements;
    const be = b.elements;
...
export function mat4Determinant(m) {
    ...
    const me = m.elements, n11 = me[0], n21 = me[1], n31 = me[2], n41 = me[3], n12 = me[4], n22 = me[5], n32 = me[6], n42 = me[7], n13 = me[8], n23 = me[9], n33 = me[10], n43 = me[11], n14 = me[12], n24 = me[13], n34 = me[14], n44 = me[15], t11 = n23 * n34 * n42 -
        n24 * n33 * n42 +
        n24 * n32 * n43 -
        n22 * n34 * n43 -
        n23 * n32 * n44 +
...
export function mat4Adjoint(m, result = new Mat4()) {
    // from gl-matrix
    const a = m.elements;
...
export function mat4Transpose(m, result = new Mat4()) {
...
export function mat4Inverse(m, result = new Mat4()) {
    // based on http://www.euclideanspace.com/maths/algebra/matrix/functions/inverse/fourD/index.htm
    const me = m.elements, n11 = me[0], n21 = me[1], n31 = me[2], n41 = me[3], n12 = me[4], n22 = me[5], n32 = me[6], n42 = me[7], n13 = me[8], n23 = me[9], n33 = me[10], n43 = me[11], n14 = me[12], n24 = me[13], n34 = me[14], n44 = me[15], t11 = n23 * n34 * n42 -
        n24 * n33 * n42 +
        n24 * n32 * n43 -
...
export function mat4Mix(a, b, t, result = new Mat4()) {
    const s = 1 - t;
    for (let i = 0; i < NUM_ELEMENTS; i++) {
...
export function mat4FromArray(array, offset = 0, result = new Mat4()) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
        result.elements[i] = array[offset + i];
    }
    return result;
}
export function mat4ToArray(a, array, offset = 0) {
    for (let i = 0; i < NUM_ELEMENTS; i++) {
        array[offset + i] = a.elements[i];
    }
}
export function mat4ToString(a) {
    return toSafeString(a.elements);
}
export function mat4Parse(text, result = new Mat4()) {
    return mat4FromArray(parseSafeFloats(text), 0, result);
}
export function mat3ToMat4(a, result = new Mat4()) {
    const ae = a.elements;
    return result.set([
        ae[0],
        ae[1],
...
export function eulerToMat4(e, result = new Mat4()) {
    return mat3ToMat4(eulerToMat3(e), result);
}
export function quatToMat4(q, result = new Mat4()) {
    return mat3ToMat4(quatToMat3(q), result);
}
export function scale3ToMat4(s, result = new Mat4()) {
    return result.set([s.x, 0, 0, 0, 0, s.y, 0, 0, 0, 0, s.z, 0, 0, 0, 0, 1]);
}
// from gl-matrix
export function mat4ToScale3(m, result = new Vec3()) {
...
export function translation3ToMat4(t, result = new Mat4()) {
    return result.set([1, 0, 0, t.x, 0, 1, 0, t.y, 0, 0, 1, t.z, 0, 0, 0, 1]);
}
export function mat4ToTranslation3(m, result = new Vec3()) {
    const me = m.elements;
    return result.set(me[3], me[7], me[11]);
}
export function mat4Translate(m, t, result = new Mat4()) {
    return mat4Multiply(m, translation3ToMat4(t), result);
}
export function mat4Scale(m, s, result = new Mat4()) {
    return mat4Multiply(m, scale3ToMat4(s), result);
}
export function mat4RotateByQuat(m, q, result = new Mat4()) {
    return mat4Multiply(m, quatToMat4(q), result);
}
export function mat4RotateByEuler(m, e, result = new Mat4()) {
    return mat4Multiply(m, eulerToMat4(e), result);
}
export function mat4TransformPoint3(m, v, result = new Vec3()) {
...
export function mat4TransformNormal3(v, m, result = new Vec3()) {
    const x = v.x, y = v.y, z = v.z;
    const e = m.elements;
...
export function mat4Perspective(left, right, top, bottom, near, far, result = new Mat4()) {
...
export function mat4PerspectiveFov(verticalFov, near, far, zoom, aspectRatio, result = new Mat4()) {
...
export function mat4Orthogonal(left, right, top, bottom, near, far, result = new Mat4()) {
...
export function mat4OrthogonalSimple(height, center, near, far, zoom, aspectRatio = 1, result = new Mat4()) {
    height /= zoom;
    const width = height * aspectRatio;
...
export function mat4LookAt(eye, target, up, result = new Mat4()) {
    const te = result.elements;
