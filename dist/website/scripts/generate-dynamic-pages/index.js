...
generatePagesFromRegistry(coreRegistry, join(__dirname, '../../docs/profiles/Core'));
...
generatePagesFromRegistry(sceneRegistry, join(__dirname, '../../docs/profiles/Scene'), sceneFunctionalRegistry);
generatePagesFromExamples(join(__dirname, '../../../graphs'), join(__dirname, '../../docs/examples'));
