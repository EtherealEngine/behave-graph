...
export function Flow(_ref: any): React$1.FunctionComponentElement<{
    nodeTypes: any;
    nodes: ReactFlow.Node<any, string | undefined>[];
    edges: ReactFlow.Edge<any>[];
    onNodesChange: (changes: ReactFlow.NodeChange[]) => void;
    onEdgesChange: (changes: ReactFlow.EdgeChange[]) => void;
...
import React$1 = require("react");
import ReactFlow = require("reactflow");
