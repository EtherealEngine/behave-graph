...
var Branch = require('behave-graph/dist/graphs/core/flow/Branch.json');
var Delay = require('behave-graph/dist/graphs/core/async/Delay.json');
var HelloWorld = require('behave-graph/dist/graphs/core//HelloWorld.json');
var Polynomial = require('behave-graph/dist/graphs/core/logic/Polynomial.json');
var SetGet = require('behave-graph/dist/graphs/core/variables/SetGet.json');
var core = require('@behave-graph/core');
var freeSolidSvgIcons = require('@fortawesome/free-solid-svg-icons');
var reactFontawesome = require('@fortawesome/react-fontawesome');
var cx = require('classnames');
var rawSpecJson = require('behave-graph/dist/node-spec.json');
function _interopDefault(e) { return e && e.__esModule ? e : { 'default': e }; }
var ReactFlow__default = /*#__PURE__*/ _interopDefault(ReactFlow);
var React__default = /*#__PURE__*/ _interopDefault(React$1);
var Branch__default = /*#__PURE__*/ _interopDefault(Branch);
var Delay__default = /*#__PURE__*/ _interopDefault(Delay);
var HelloWorld__default = /*#__PURE__*/ _interopDefault(HelloWorld);
var Polynomial__default = /*#__PURE__*/ _interopDefault(Polynomial);
var SetGet__default = /*#__PURE__*/ _interopDefault(SetGet);
var cx__default = /*#__PURE__*/ _interopDefault(cx);
var rawSpecJson__default = /*#__PURE__*/ _interopDefault(rawSpecJson);
...
var Modal = _ref => {
    var { open = false, onClose, title, children, actions } = _ref;
    ...
    }, actions.map((action, ix) => /*#__PURE__*/ React__default["default"].createElement("button", {
        key: ix,
...
var ClearModal = _ref => {
    var { open = false, onClose } = _ref;
    var instance = ReactFlow.useReactFlow();
    var handleClear = () => {
        instance.setNodes([]);
        instance.setEdges([]);
...
var examples = {
    branch: Branch__default["default"],
    delay: Delay__default["default"],
    helloWorld: HelloWorld__default["default"],
    polynomial: Polynomial__default["default"],
    setGet: SetGet__default["default"]
};
var LoadModal = _ref => {
    var { open = false, onClose } = _ref;
    var [value, setValue] = React$1.useState();
    var [selected, setSelected] = React$1.useState("");
    var instance = ReactFlow.useReactFlow();
    var handleLoad = () => {
        var graph;
        if (value !== undefined) {
...
var getNodeSpecJSON = () => {
    if (nodeSpecJSON$1 === undefined) {
        var registry = new core.Registry();
        core.registerCoreProfile(registry);
        core.registerSceneProfile(registry);
        nodeSpecJSON$1 = core.writeNodeSpecsToJSON(registry);
    }
...
var SaveModal = _ref => {
    ...
    var [copied, setCopied] = React$1.useState(false);
    var edges = ReactFlow.useEdges();
    var nodes = ReactFlow.useNodes();
    var flow = React$1.useMemo(() => flowToBehave(nodes, edges), [nodes, edges]);
...
var AutoSizeInput = _ref => {
    var { minWidth = 30 } = _ref, props = _objectWithoutProperties(_ref, _excluded);
    var inputRef = React$1.useRef(null);
    var measureRef = React$1.useRef(null);
    var [styles, setStyles] = React$1.useState({});
    // grab the font size of the input on ref mount
    var setRef = React$1.useCallback(input => {
        if (input) {
...
var CustomControls = () => {
    var [loadModalOpen, setLoadModalOpen] = React$1.useState(false);
    var [saveModalOpen, setSaveModalOpen] = React$1.useState(false);
    var [helpModalOpen, setHelpModalOpen] = React$1.useState(false);
    var [clearModalOpen, setClearModalOpen] = React$1.useState(false);
    var instance = ReactFlow.useReactFlow();
    var handleRun = /*#__PURE__*/ function () {
        var _ref = _asyncToGenerator(function* () {
            var registry = new core.Registry();
            var logger = new core.DefaultLogger();
            var manualLifecycleEventEmitter = new core.ManualLifecycleEventEmitter();
            core.registerCoreProfile(registry, logger, manualLifecycleEventEmitter);
            core.registerSceneProfile(registry);
            var nodes = instance.getNodes();
            var edges = instance.getEdges();
            var graphJson = flowToBehave(nodes, edges);
            var graph = core.readGraphFromJSON(graphJson, registry);
            var engine = new core.Engine(graph);
    ...
    return /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement(ReactFlow.Controls, null, /*#__PURE__*/ React.createElement(ReactFlow.ControlButton, {
        title: "Help",
        onClick: () => setHelpModalOpen(true)
    }, /*#__PURE__*/ React.createElement(reactFontawesome.FontAwesomeIcon, {
        icon: freeSolidSvgIcons.faQuestion
    })), /*#__PURE__*/ React.createElement(ReactFlow.ControlButton, {
        title: "Load",
...
function InputSocket(_ref) {
    ...
    var { connected, value, onChange: _onChange, name, valueType, defaultValue } = _ref;
    var instance = ReactFlow.useReactFlow();
    ...
    }, isFlowSocket && /*#__PURE__*/ React.createElement(reactFontawesome.FontAwesomeIcon, {
    ...
    })), /*#__PURE__*/ React.createElement(ReactFlow.Handle, {
        id: name,
        type: "target",
        position: ReactFlow.Position.Left,
        className: cx__default["default"](borderColor, connected ? backgroundColor : "bg-gray-800"),
        isValidConnection: connection => isValidConnection(connection, instance)
    }));
}
function NodeContainer(_ref) {
    var { title, category = "None", selected, children } = _ref;
    ...
    return /*#__PURE__*/ React.createElement("div", {
        className: cx__default["default"]("rounded text-white text-sm bg-gray-800 min-w-[120px]", selected && "outline outline-1")
    }, /*#__PURE__*/ React.createElement("div", {
...
function OutputSocket(_ref) {
    var { connected, valueType, name } = _ref;
    var instance = ReactFlow.useReactFlow();
    var isFlowSocket = valueType === "flow";
    var colorName = valueTypeColorMap[valueType];
    if (colorName === undefined) {
    ...
    }, name), isFlowSocket && /*#__PURE__*/ React.createElement(reactFontawesome.FontAwesomeIcon, {
        icon: freeSolidSvgIcons.faCaretRight,
        color: "#ffffff",
        size: "lg",
        className: "ml-1"
...
var useChangeNodeData = id => {
    var instance = ReactFlow.useReactFlow();
    return React$1.useCallback((key, value) => {
...
var Node = _ref => {
    var { id, data, spec, selected } = _ref;
    var edges = ReactFlow.useEdges();
...
var specJSON$2 = rawSpecJson__default["default"];
var nodes = specJSON$2;
var NodePicker = _ref => {
    var { position, onPickNode, onClose, filters } = _ref;
    var [search, setSearch] = React$1.useState("");
    var instance = ReactFlow.useReactFlow();
    useOnPressKey("Escape", onClose);
    var filtered = nodes;
...
var Flow = _ref => {
    var { graph } = _ref;
    var [nodePickerVisibility, setNodePickerVisibility] = React$1.useState();
    var [lastConnectStart, setLastConnectStart] = React$1.useState();
    var [initialNodes, initialEdges] = React$1.useMemo(() => behaveToFlow(graph), [graph]);
    var [nodes, , onNodesChange] = ReactFlow.useNodesState(initialNodes);
    var [edges, , onEdgesChange] = ReactFlow.useEdgesState(initialEdges);
    var onConnect = React$1.useCallback(connection => {
    ...
    var handleAddNode = React$1.useCallback((nodeType, position) => {
        closeNodePicker();
        var newNode = {
            id: uuid.v4(),
            type: nodeType,
    ...
    return /*#__PURE__*/ React.createElement(ReactFlow__default["default"], {
    ...
    }, /*#__PURE__*/ React.createElement(CustomControls$1, null), /*#__PURE__*/ React.createElement(ReactFlow.Background, {
...
exports.categoryColorMap = categoryColorMap;
exports.colors = colors;
exports.customNodeTypes = customNodeTypes;
...
exports.valueTypeColorMap = valueTypeColorMap;
export {};
//# sourceMappingURL=behave-graph-flow.cjs.prod.js.map