...
class LogList extends FlowNode {
...
LogList.Description = (logger) => new NodeDescription('debug/log/list', 'Action', 'Log', (description, graph) => new LogList(description, graph, logger));
export { LogList };
